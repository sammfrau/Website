...
let buttonVideos  = document.getElementById('buttonVideos');

// Defining elements
let linkHome = '/index.html';
let linkAbout = '/about.html';
let linkVideos = '/videos.html';
...
buttonVideos.addEventListener('click', function()
{
    gotoLink(linkVideos);
});
...
// Accessing elements
let buttonPage1 = document.getElementById('buttonPage1');
let areaPage1 = document.getElementById('areaPage1');
let buttonPage2 = document.getElementById('buttonPage2');
let areaPage2 = document.getElementById('areaPage2');


// Attaches the event listeners to this page's button for visibility
buttonPage1.addEventListener('click', function()
{
    toggleVisibility(areaPage1);
});
buttonPage2.addEventListener('click', function()
{
    toggleVisibility(areaPage2);
});